...
case class BasicBlock(data: AbstractStatementContainer, id: Int)
    extends NodeLike[BasicBlock] {
...
object BasicBlock {
  ...
  def getMethodSig(bb: BasicBlock): Option[MethodSig] =
    idToMethodSigMap.get(bb.id)
}
