...
object BackwardAnalysis {
  ...
  class FlowInsensitiveBackwardAnalysis[D<:Galois](val cfg: CFG)(implicit val ops: LatticeOps[D], val absTransfer: AbstractTransferable[D], val widening: Option[Widening[D]] = None) extends FlowInsensitiveFixedPointComputation[D] with WideningAtLoopHeads[D] {
  ...
  class FlowSensitiveBackwardAnalysis[D <: Galois](val cfg: CFG)(implicit val ops: LatticeOps[D], val absTransfer: AbstractTransferable[D], val widening: Option[Widening[D]] = None) extends FlowSensitiveFixedPointComputation[D] with WideningAtLoopHeads[D] {
    def getNextBlocks(bb: BasicBlock) = cfg.getPrevs(bb).toList
